  ...
  return (
    <div>
      ...
      <PageHeader 
        ...
        description={series ? `Créé le ${new Date(series.createdAt).toLocaleDateString("fr-FR")} • Modifié le ${new Date(series.updatedAt || series.createdAt).toLocaleDateString("fr-FR")}` : undefined}
