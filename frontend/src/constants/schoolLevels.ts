 ...
 */
export const SCHOOL_LEVELS: Record<SchoolCategory, LevelOption[]> = {
  primaire: [
    { value: 'CP', label: 'CP' },
    { value: 'CE1', label: 'CE1' },
    { value: 'CE2', label: 'CE2' },
 ...
 */
export function getLevelsByCategory(category: SchoolCategory): LevelOption[] {
  return SCHOOL_LEVELS[category] || [];
}

/**
 * Récupère tous les niveaux, toutes catégories confondues
 */
export function getAllLevels(): LevelOption[] {
  return Object.values(SCHOOL_LEVELS).flat();
}

/**
 * Options pour select de catégorie
 */
export function getCategoryOptions(): LevelOption[] {
