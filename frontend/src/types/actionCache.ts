...
export type BusinessAction = 
  ...
  | 'DELETE_STUDENT'        // Suppression d'un élève
  | 'UPDATE_STUDENT'        // Mise à jour d'un élève existant
  ...
  // Actions RDV
  | 'CREATE_RDV'            // Création d'un RDV
  | 'UPDATE_RDV'            // Mise à jour d'un RDV
  | 'DELETE_RDV';           // Suppression d'un RDV
